...
class GeminiProvider:
    """Gemini API Provider wrapper conforming to the BaseLLMProvider protocol."""
    ...
    async def generate(
        ...
        raise NotImplementedError("Gemini provider is not fully implemented yet.")
    ...
    async def stream(
        ...
        yield {"content": "Gemini streaming placeholder", "finish_reason": "stop"}
