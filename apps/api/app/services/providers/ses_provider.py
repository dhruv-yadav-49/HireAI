...
class SESProvider(CommunicationProvider):
    """Placeholder AWS SES provider using boto3 client integration."""
    ...
    async def send(
        ...
        return {
            "provider_message_id": f"ses_mock_{uuid.uuid4().hex[:12]}",
            "status_code": 200,
            "provider_latency_ms": latency,
            "provider_response": {"message": "Mock SES API call succeeded"},
